...
export default function TabBar({
  ...
  return (
    <View className="absolute border-[1px] border-gray-500 bottom-[20px] right-0 left-0  mx-5 bg-gray-900 px-8 flex flex-row items-center justify-between py-3 rounded-full shadow-xl shadow-black/30">
